...
import 'app_settings_management_view.dart'; // ✅ Added
...
class _AdminDashboardViewState extends State<AdminDashboardView> {
  ...
  Widget build(BuildContext context) {
    final List<Widget> pages = [
      ...
      const AppSettingsManagementView(), // ✅ Added
    ];
    ...
    final List<String> pageTitles = [
      ...
      'إدارة المدن', // ✅ Added
      'إدارة الإعلانات',
      'إعدادات التطبيق', // ✅ Added
    ];

    return PopScope(
      canPop: false, // Prevent accidental back navigation/swipes
      onPopInvokedWithResult: (bool didPop, dynamic result) {
        if (didPop) return;
        // Optional: Show a snackbar or dialog if user really wants to exit
        // For now, silently blocking the gesture solves the user's issue
      },
      child: Scaffold(
